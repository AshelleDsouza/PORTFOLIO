...
export default function Footer() {
  return (
    <footer className="w-full border-t border-white/[0.05] bg-[#06060a] py-12">
        ...
        <div className="grid grid-cols-1 gap-8 md:grid-cols-3">
          ...
          <div className="flex flex-col gap-4">
            ...
            <p className="text-sm text-gray-400 max-w-xs">
              MCA student at CHRIST (Deemed to be University) with a passion for web development, software design, and databases.
            </p>
          </div>
          ...
          <div className="flex flex-col gap-3">
            ...
            <ul className="grid grid-cols-2 gap-2 text-sm text-gray-400">
              ...
              <li>
                <Link href="/skills" className="hover:text-accent-red transition-colors">Skills</Link>
              </li>
              <li>
                <Link href="/projects" className="hover:text-accent-red transition-colors">Projects</Link>
              </li>
              <li>
                <Link href="/achievements" className="hover:text-accent-red transition-colors">Achievements</Link>
              </li>
              <li>
          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="flex items-center gap-4">
              <a
                ...
                className="flex h-9 w-9 items-center justify-center rounded-full bg-white/5 border border-white/10 text-gray-400 hover:text-white hover:border-accent-red transition-all duration-300"
                aria-label="GitHub"
              >
              ...
              <a
                href="mailto:ashellejd@gmail.com"
                className="flex h-9 w-9 items-center justify-center rounded-full bg-white/5 border border-white/10 text-gray-400 hover:text-white hover:border-accent-red transition-all duration-300"
                aria-label="Email"
              >
            ...
            <p className="text-xs text-gray-500">
              Email: ashellejd@gmail.com<br />
              Location: Karnataka, India
            </p>
          </div>
        </div>

        <div className="mt-8 border-t border-white/[0.05] pt-8 text-center text-xs text-gray-500">
          <p>© {new Date().getFullYear()} Ashelle Jeema Dsouza. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
